...
var keywords = map[string]TokenType{"let": TokLet, "var": TokVar, "const": TokConst, "function": TokFunction, "return": TokReturn, "if": TokIf, "else": TokElse, "while": TokWhile, "true": TokTrue, "false": TokFalse, "null": TokNull, "undefined": TokUndefined, "new": TokNew, "typeof": TokTypeof}
